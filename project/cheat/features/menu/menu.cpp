...
void menu::routine( float ease_animation )
{
	...
	if ( ImGui::Begin( "Aimbot", nullptr, ImGuiWindowFlags_AlwaysAutoResize ) ) {
		ImGui::Checkbox( "RCS", g_config.find< bool >( _hash( "aimbot_rcs" ) ) );

		if ( *g_config.find< bool >( _hash( "aimbot_rcs" ) ) ) {
			ImGui::PushItemWidth( -1 );
			ImGui::SliderFloat( "##RCS X", g_config.find< float >( _hash( "aimbot_rcs_x" ) ), 0, 150.f, "X: %0.1f%" );
			ImGui::SliderFloat( "##RCS Y", g_config.find< float >( _hash( "aimbot_rcs_y" ) ), 0, 150.f, "Y: %0.1f%" );
			ImGui::SliderFloat( "##RCS SMOOTH", g_config.find< float >( _hash( "aimbot_rcs_smooth" ) ), 0, 2.f, "Smooth: %0.1f%" );

			ImGui::PopItemWidth( );

			ImGui::Checkbox( "RCS Error", g_config.find< bool >( _hash( "aimbot_rcs_error" ) ) );
		}
	...
	if ( ImGui::Begin( "Visuals", nullptr, ImGuiWindowFlags_AlwaysAutoResize ) ) {
		...
		ImGui::ColorEdit4( "##Boxes Color", reinterpret_cast< float* >( g_config.find< ImVec4 >( _hash( "visuals_boxes_color" ) ) ),
		                   ImGuiColorEditFlags_NoInputs );

		ImGui::Checkbox( "Names", g_config.find< bool >( _hash( "visuals_names" ) ) );
		ImGui::SameLine( );

		ImGui::ColorEdit4( "##Names Color", reinterpret_cast< float* >( g_config.find< ImVec4 >( _hash( "visuals_names_color" ) ) ),
		                   ImGuiColorEditFlags_NoInputs );

		ImGui::Checkbox( "Weapons", g_config.find< bool >( _hash( "visuals_weapons" ) ) );
		ImGui::SameLine( );

		ImGui::ColorEdit4( "##Weapons Color", reinterpret_cast< float* >( g_config.find< ImVec4 >( _hash( "visuals_weapons_color" ) ) ),
		                   ImGuiColorEditFlags_NoInputs );

		ImGui::Checkbox( "Weapon Icons", g_config.find< bool >( _hash( "visuals_weapons_icons" ) ) );

		ImGui::Checkbox( "Health Bars", g_config.find< bool >( _hash( "visuals_health_bars" ) ) );
		ImGui::SameLine( );

		ImGui::ColorEdit4( "##Health Bars Color", reinterpret_cast< float* >( g_config.find< ImVec4 >( _hash( "visuals_health_bars_color" ) ) ),
		                   ImGuiColorEditFlags_NoInputs );

		ImGui::Checkbox( "Recoil Crosshair", g_config.find< bool >( _hash( "visuals_recoil_crosshair" ) ) );
		ImGui::SameLine( );

		ImGui::ColorEdit4( "##Recoil Crosshair Color",
		                   reinterpret_cast< float* >( g_config.find< ImVec4 >( _hash( "visuals_recoil_crosshair_color" ) ) ),
		                   ImGuiColorEditFlags_NoInputs );
	...
	if ( ImGui::Begin( "Movement", nullptr, ImGuiWindowFlags_AlwaysAutoResize ) ) {
		ImGui::Checkbox( "Bunny Hop", g_config.find< bool >( _hash( "movement_bunny_hop" ) ) );

		if ( *g_config.find< bool >( _hash( "movement_bunny_hop" ) ) ) {
			ImGui::PushItemWidth( -1 );
			ImGui::SliderInt( "##Bhop Delay", g_config.find< int >( _hash( "movement_bunny_hop_delay" ) ), 0, 100, "Delay: %dms" );
			ImGui::PopItemWidth( );
			...
			ImGui::Checkbox( "Bunny Hop Error", g_config.find< bool >( _hash( "movement_bunny_hop_error" ) ) );
		}
